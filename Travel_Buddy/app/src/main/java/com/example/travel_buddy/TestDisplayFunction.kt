...
@Composable
fun TestDisplay(name: String, dataEntryViewModel: DataEntryViewModel = viewModel(), navigationViewModel: NavigationViewModel = viewModel(), modifier: Modifier = Modifier) {
